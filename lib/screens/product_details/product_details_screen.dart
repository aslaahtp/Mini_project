...
import 'package:grocery_app/screens/seller_details.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Spacer(),
                        Text(
                          "Rs.${getTotalPrice().toStringAsFixed(1)}",
                          style: TextStyle(
                            fontSize: 24,
                    ...
                    Spacer(),
                    Divider(thickness: 1),
                    getProductDataRowWidget("Seller Details"),
                    Divider(thickness: 1),
                    getProductDataRowWidget(
                      "Review",
                      customWidget: ratingWidget(widget.groceryItem.rating),
                    ),
                    Spacer(),
                    AppButton(
                      label: "Add To Basket",
  ...
  void onSellerClicked(BuildContext context) {
    Navigator.push(
      context,
